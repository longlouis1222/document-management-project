...
import modelData from './ProjectRegistrationModel'

const defaultFilter = DataService.defaultFilter

const router = useRouter()
const moduleName = 'Đề tài đăng ký'
...
const getTopicApprovedList = async () => {
  let dataFilter = {
  ...
  const res = await StudentApi.getListTopicApproved(filter)
  if (res.status === 200) {
